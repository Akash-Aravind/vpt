...
tokens=['அங்கதேசம்\u200c', '-' , 'இது', ',', 'உரோமபதன்\u200c', 'அர', 'சாட்சியில்\u200c', 'மழையில்லாமலிருந்தது', '(',  'பின்ன     னால்\u200c','-', '௬சியசிங்க', 'முனிவர்வரவால்\u200c', 'மழைபெய்யப்\u200c',')' ,'பெற்றது', '.', 'இந்த', 'ராஜ       ஜ்யத்\u200c', 'அங்கதேசம்\u200c','அங்கதேசம்\u200c', '-', 'இது', ',', 'உரோமபதன்\u200c', 'அர', 'சாட்சியில்\u200c','-']
# for i in tokens:
#     print(i)
